...
{
	public class ArachknifeProj : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Arachknife");
		}
		...
		public override void OnKill(int timeLeft)
		{
			...
			{
				Dust dust = Dust.NewDustDirect(usePos, Projectile.width, Projectile.height, 0);
		...
		private void UpdateStickyJavelins(NPC target)
		{
			...
			for (int i = 0; i < Main.maxProjectiles; i++) 
			{
				...
				if (i != Projectile.whoAmI 
					...
					&& currentProjectile.ModProjectile is ArachknifeProj daggerProjectile 
