...
namespace NimblesThrowingStuff.Projectiles.Throwing
{
	public class LacusDecapitatorProj: ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (lacdex >= 20)
                    {
                        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, Projectile.velocity.X, Projectile.velocity.Y, Mod.Find<ModProjectile>("LacusEcho").Type, Projectile.damage / 2, 5f, Projectile.owner, 0.0f, (float) Main.rand.Next(-45, 1));
                lacdex = 0;
                    }
        }
