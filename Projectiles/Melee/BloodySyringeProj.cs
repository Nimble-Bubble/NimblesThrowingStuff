...
namespace NimblesThrowingStuff.Projectiles.Melee
{
	public class BloodySyringeProj: ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.mouseRight)
            {
                    Projectile.NewProjectile(projectile.Center, projectile.velocity * 1.5f, ModContent.ProjectileType<BloodySyringeBlood>(), projectile.damage / 3, 1.5f, projectile.owner); 
