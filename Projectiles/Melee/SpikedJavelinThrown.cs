...
{
	public class SpikedJavelinThrown: ModProjectile
    {
		...
		private void UpdateStickyJavelins(NPC target)
		{
			...
			for (int i = 0; i < Main.maxProjectiles; i++) 
			{
				...
				if (i != Projectile.whoAmI 
					...
					&& currentProjectile.ModProjectile is SpikedJavelinThrown daggerProjectile 
        ...
        {
            Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 2,
