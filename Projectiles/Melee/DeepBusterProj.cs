...
{
    public class DeepBusterProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Projectile.GetGlobalProjectile<NimblesGlobalProjectile>().maxShells = 8 + projOwner.GetModPlayer<NimblesPlayer>().bonusShells;
