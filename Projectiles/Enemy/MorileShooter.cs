...
namespace NimblesThrowingStuff.Projectiles.Enemy
{
    public class MorileShooter : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), vector8, new Vector2((float)((Math.Cos(rotation) * 8f) * -1), (float)((Math.Sin(rotation) * 8f) * -1)), Mod.Find<ModProjectile>("MorileShot").Type, Projectile.damage, Projectile.knockBack, Projectile.owner);
        }
    }
}
