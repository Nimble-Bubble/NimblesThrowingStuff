...
{
	public class ViolentClusterProj : ModProjectile
	{
		...
		public override void AI() {
			...
			if (player.dead || !player.active) {
				player.ClearBuff(Mod.Find<ModBuff>("ViolentClusterBuff").Type);
			}
			if (player.HasBuff(Mod.Find<ModBuff>("ViolentClusterBuff").Type)) {
